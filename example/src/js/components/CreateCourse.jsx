...
class CreateCourse extends React.Component {
  ...
  handleCourseTitleChange(e) {
    this.props.actions.changeNewCourseTitle(e.target.value);
  }

  handleCourseLengthChange(e) {
    this.props.actions.changeNewCourseLength(e.target.value);
  }

  handleCourseCategoryChange(e) {
    this.props.actions.changeNewCourseCategory(e.target.value);
  }
